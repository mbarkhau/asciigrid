...
RUN sed -i 's/https:\/\/mbarkhau.pythonanywhere.com\/bob2svg/http:\/\/localhost:4001\/bob2svg/g' /var/www/html/app.mjs
...
RUN echo "/usr/local/bin/gunicorn app:app -b 0.0.0.0:4001" >> /var/www/html/start.sh
